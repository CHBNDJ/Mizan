...
//     // Animation pour "Aucun avis" - reste de gauche à droite
//     gsap.fromTo(
//       ".no-reviews",
//       { autoAlpha: 0, x: -50 },
//       {
...
//     // Animation pour le formulaire - DE DROITE À GAUCHE
//     gsap
//       .timeline({
//         defaults: { ease: "power2.out" },
//         scrollTrigger: {
...
//       {reviews.length === 0 ? (
//         <div className="no-reviews text-center py-12 bg-slate-50 rounded-lg">
//           <p className="text-slate-600 text-lg">Aucun avis pour le moment</p>
//           <p className="text-sm text-slate-500 mt-2">
//             Soyez le premier à laisser un avis
//           </p>
...
//             <div
//               key={review.id}
//               className="review-card bg-white rounded-xl p-6 shadow-sm border border-slate-200 hover:shadow-lg transition-all duration-300"
//             >
//               <div className="flex items-start gap-4 mb-4">
//                 <Quote className="w-6 h-6 text-teal-500 flex-shrink-0 mt-1" />
//                 <div className="flex-1 min-w-0">
...
//       {(!profile || profile.user_type === "client") && (
//         <div className="review-form bg-gradient-to-br from-teal-50 to-white rounded-xl p-8 border border-teal-100 shadow-sm">
//           <h3 className="text-2xl font-semibold text-slate-800 mb-6">
//             Partagez votre expérience
//           </h3>
//           {!user ? (
