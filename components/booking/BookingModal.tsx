...
export default function BookingModal({
  ...
  const inp =
    "w-full h-11 px-3 text-sm border border-slate-200 rounded-xl bg-white focus:border-teal-400 focus:border-2 outline-none transition-all";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white rounded-t-2xl sm:rounded-2xl shadow-xl w-full sm:max-w-lg z-10">
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            {step !== "date" && step !== "done" && (
              <button
                onClick={() => setStep(step === "form" ? "time" : "date")}
                className="w-7 h-7 rounded-lg hover:bg-slate-100 flex items-center justify-center cursor-pointer"
              >
        ...
        <div className="p-5">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-3">
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-slate-200 flex items-center justify-center cursor-pointer disabled:opacity-30 hover:border-teal-300"
                >
                  <ChevronLeft className="w-4 h-4 text-slate-500" />
                </button>
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-slate-200 flex items-center justify-center cursor-pointer hover:border-teal-300"
                >
          ...
          {step === "form" && selectedDate && selectedSlot && (
            <div>
              <div className="bg-teal-50 border border-teal-100 rounded-xl p-3 mb-4 flex items-center gap-3">
              ...
              <button
                ...
                className="mt-4 w-full bg-teal-600 hover:bg-teal-700 disabled:opacity-40 text-white py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 cursor-pointer transition-all"
              >
                {sending ? (
                  <>
