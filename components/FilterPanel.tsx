...
export function FilterPanel({
  ...
  const isTraducteur = searchParams?.get("profession") === "traducteur";

  const langueOptionsBase = [
    {
      value: "Français",
      label:
        locale === "ar" ? "الفرنسية" : locale === "en" ? "French" : "Français",
  ...
  const langueOptions = isTraducteur
    ? langueOptionsTraducteur
    : langueOptionsBase;
