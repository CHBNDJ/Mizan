...
function MizanLogo() {
  return (
    <div className="bg-white dark:bg-[#1c1c1e] border border-teal-500 dark:border-[#6fcf9f]/40 rounded-xl p-1 flex items-center justify-center transition-all duration-200 hover:shadow-md cursor-pointer">
      <img
