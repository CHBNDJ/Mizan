...
//       {/* ✅ CORRECTION: Ajout de z-50 sur le conteneur parent */}
...
//         {/* ✅ CORRECTION CRITIQUE: z-[100] pour le dropdown - AU-DESSUS DE TOUT */}
//         {isOpen && (
//           <div className="absolute z-[100] w-full mt-2 bg-white border-2 border-teal-200 rounded-lg shadow-xl max-h-64 overflow-hidden">
//             {/* Zone de scroll */}
//             <div className="max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-teal-300 scrollbar-track-slate-100">
//               {filteredOptions.length === 0 ? (
//                 <div className="px-4 py-3 text-sm text-slate-500 bg-slate-50">
...
export function CustomSelect({
  ...
  return (
    <div className="space-y-2">
      ...
      {/* ✅ CORRECTION CRITIQUE: z-[999] sur le conteneur parent */}
      <div ref={selectRef} className="relative z-[999]">
        <div
          onClick={toggleOpen}
          className={cn(
            "w-full px-3 py-2 border-2 border-slate-300 rounded-lg bg-white cursor-pointer flex items-center justify-between",
        ...
        {/* ✅ CORRECTION CRITIQUE: z-[9999] pour le dropdown */}
        {isOpen && (
