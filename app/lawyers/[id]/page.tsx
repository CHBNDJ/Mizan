    ...
    <div className="min-h-screen pt-24 bg-gradient-to-br from-teal-100 via-white to-teal-100 overflow-x-hidden w-full">
      <div>
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:gap-6">
            <div className="profile-avatar w-40 h-40 mb-4 flex-shrink-0 mx-auto sm:mx-0">
              {avocat.avatar_url ? (
                <img
                  src={avocat.avatar_url}
                  alt={`${avocat.prenom} ${avocat.nom}`}
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-3">
                    {avocat.specialites.map((spec: string, index: number) => (
                      <span
                        key={index}
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-teal-50 text-teal-700 rounded-full text-base font-medium border border-teal-100 hover:bg-teal-100 hover:border-teal-200 transition-all shadow-sm"
                      >
                        <span className="w-2 h-2 bg-teal-600 rounded-full"></span>
                        {spec}
                      </span>
