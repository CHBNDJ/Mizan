...
export default function ProfilePage({ params }: ProfilePageProps) {
  ...
  useEffect(() => {
    ...
    // Animation du header (avatar + infos) - De gauche
    gsap
    ...
    <div className="min-h-screen pt-24 bg-gradient-to-br from-teal-100 via-white to-teal-100">
      ...
      <div>
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center mb-4">
            <button
              onClick={handleBackToResults}
              className="back-button flex items-center gap-2 text-teal-600 hover:text-teal-700 transition-colors cursor-pointer"
            >
              <ArrowLeft className="w-4 h-4" />
              <span className="hidden sm:inline">Retour aux résultats</span>
              <span className="sm:hidden">Retour</span>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-6">
            <div className="profile-avatar w-24 h-24 mb-4 flex-shrink-0 mx-auto sm:mx-0">
              {avocat.avatar_url ? (
                <img
                  src={avocat.avatar_url}
                  alt={`${avocat.prenom} ${avocat.nom}`}
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                <div className="flex-1">
                  <h1 className="profile-name text-2xl sm:text-3xl font-bold text-slate-800 mb-2 text-center sm:text-left">
                    {toCivilite(avocat.genre)} {avocat.prenom} {avocat.nom}
                  </h1>

                  <div className="profile-location flex flex-col sm:flex-row sm:items-center sm:gap-4 text-slate-600 mb-4 text-center sm:text-left">
                    <div className="flex items-center gap-1 justify-center sm:justify-start">
                      <MapPin className="w-4 h-4" />
                      <span>
                        {avocat.ville}, {avocat.wilaya}
                  ...
                  {((avocat.rating_google &&
                    ...
                    (avocat.rating_mizan &&
                      (avocat.reviews_count_mizan ?? 0) > 0)) && (
                    <div className="profile-ratings flex flex-col sm:flex-row sm:items-center gap-3 text-center sm:text-left mt-4">
                      {avocat.rating_google &&
                        (avocat.reviews_count_google ?? 0) > 0 && (
                          <div className="flex items-center justify-center sm:justify-start gap-2 text-yellow-500">
                            <Star className="w-5 h-5 fill-current" />
                  ...
                  {avocat.verified && (
                    <div className="profile-verified flex items-center justify-center sm:justify-start gap-1 text-teal-600 mt-3">
                      <CheckCircle className="w-5 h-5" />
                      <span className="font-medium">Vérifié</span>
                    </div>
                  )}
                ...
                <div className="profile-price text-center sm:text-right mt-4 sm:mt-0">
                  <div className="text-xl sm:text-2xl font-bold text-teal-600">
                    {formatPrice(tarifEstime)}
                  </div>
                  <div className="text-sm text-slate-500">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            {avocat.specialites && avocat.specialites.length > 0 && (
              <Card className="card-expertise transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center gap-2 text-lg font-semibold text-slate-800">
                    <Briefcase className="w-5 h-5" />
                    Domaines d'expertise
            ...
            <Card className="card-experience transition-all duration-300">
              <CardHeader>
                <div className="flex items-center gap-2 text-lg font-semibold text-slate-800">
                  <Calendar className="w-5 h-5" />
                  Expérience professionnelle
            ...
            {avocat.langues && avocat.langues.length > 0 && (
              <Card className="card-languages transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center gap-2 text-lg font-semibold text-slate-800">
                    <Languages className="w-5 h-5" />
                    Langues parlées
            ...
            <Card className="card-address transition-all duration-300">
              <CardHeader>
                <div className="flex items-center gap-2 text-lg font-semibold text-slate-800">
                  <MapPin className="w-5 h-5" />
                  Adresse du cabinet
          ...
          <div className="lg:sticky lg:top-24 space-y-6">
            {user && profile?.id === avocat.id && (
              <Card className="sidebar-card transition-all duration-300">
                <CardHeader>
                  <div>
                    <h3 className="text-lg font-semibold text-slate-800">
                      Contact
            ...
            {!isOwnProfile && (!user || profile?.user_type !== "client") && (
              <Card className="sidebar-card bg-white shadow-sm transition-all duration-300">
                <CardContent className="p-6 text-center">
                  <p className="text-slate-700 font-semibold mb-3">
                    Connectez-vous pour voir les coordonnées
                  </p>
            ...
            {(!user || profile?.user_type === "client") && !isOwnProfile && (
              <Card className="sidebar-card transition-all duration-300 shadow-sm hover:shadow-md">
                <CardContent className="p-4 sm:p-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <button
                      onClick={() => setIsConsultationModalOpen(true)}
