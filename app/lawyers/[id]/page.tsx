...
//           lawyer_id: avocat.id,
//           viewer_id: null, // On ne gère pas les viewers connectés pour l'instant
//           viewer_ip: ip,
//         });

//         // Si erreur de doublon, c'est normal (déjà vu aujourd'hui)
//         if (error && !error.message.includes("duplicate")) {
//           console.error("Erreur tracking:", error);
//         } else if (!error) {
//           console.log("✅ Vue de profil enregistrée");
//         }
//       } catch (error) {
...
//             {/* Bandeau Claim - Layout vertical centré */}
//             {!avocat.is_claimed && (
