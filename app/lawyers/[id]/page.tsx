...
//             Consulter Maître {avocat.prenom} {avocat.nom}
//           </p>
...
//                           className="flex-1 cursor-pointer bg-teal-600 hover:bg-teal-700 text-white py-2.5 px-4 rounded-xl flex items-center justify-center gap-2 font-semibold text-sm transition-all shadow-sm"
//                         >
...
//               <button
//                 onClick={() => setIsVideoModalOpen(true)}
//                 className="w-full cursor-pointer bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 transition-all shadow-sm"
//               >
    ...
    <div className="min-h-screen pt-16 pb-24 lg:pb-8 bg-gradient-to-br from-teal-100 via-white to-teal-100 overflow-x-hidden w-full">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4">
          ...
          {/* ── Consultation panel — pleine largeur sous le hero (desktop) ── */}
          {showConsultPanel && (
            <div className="content-card opacity-0 invisible hidden sm:block">
              <ConsultationPanel
                avocat={avocat}
                pricingChannels={pricingChannels}
                user={user}
