    ...
    <div className="min-h-screen pt-16 bg-gradient-to-br from-teal-100 via-white to-teal-100">
      ...
      <section className="cta-section py-16 bg-teal-500">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Link href="/">
            <button className="cta-button bg-white text-teal-600 px-8 py-3 rounded-lg font-semibold hover:bg-gradient-to-r hover:from-white hover:to-teal-50 hover:shadow-xl hover:scale-105 transition-all duration-500 ease-out shadow-sm border border-teal-100 cursor-pointer">
              Rechercher un avocat
            </button>
          </Link>
        </div>
