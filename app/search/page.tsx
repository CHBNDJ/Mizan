...
//       initialFilters.specialite = specialites;
//     }

//     if (wilayaParam) {
//       initialFilters.wilaya = wilayaParam;
//     }

//     if (genreParam) {
//       initialFilters.genre = genreParam as "homme" | "femme";
//     }
...
//     if (languesParam) {
//       initialFilters.langues = languesParam;
//     }
...
//     if (specialites.length > 0) {
//       newFilters.specialite = specialites;
//     }
...
//     if (genreParam) {
//       newFilters.genre = genreParam as "homme" | "femme";
//     }

//     if (experienceParam) {
//       newFilters.experience_min = parseInt(experienceParam);
//     }

//     if (languesParam) {
//       newFilters.langues = languesParam;
//     }
...
//     if (newFilters.wilaya) {
//       params.set("wilaya", newFilters.wilaya);
//     }
...
//     if (newFilters.langues) {
//       params.set("langues", newFilters.langues);
//     }
...
//     if (specialites.length > 0) {
//       urlFilters.specialite = specialites;
//     }

//     if (wilayaParam) {
//       urlFilters.wilaya = wilayaParam;
//     }
...
//     switch (sortType) {
//       case "rating":
//         return sorted.sort((a: AvocatData, b: AvocatData) => {
...
//       case "experience":
//         return sorted.sort((a: AvocatData, b: AvocatData) => {
//           return b.experience.annees - a.experience.annees;
//         });
...
//     titreRecherche.push(
//       `${specialitesURL.length} spécialité${
//         specialitesURL.length > 1 ? "s" : ""
//       }`
//     );
//   }
//   if (wilayaURL) {
//     titreRecherche.push(`à ${wilayaURL}`);
//   }
...
//           <Link href="/">
//             <button className="flex items-center gap-2 text-teal-600 cursor-pointer">
