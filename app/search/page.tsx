...
//       {/* ✅ FIX: Ajout de relative z-20 pour que les filtres soient au-dessus */}
...
//       {/* ✅ Header avec z-30 pour être au-dessus de tout */}
//       <div className="max-w-7xl mx-auto px-4 py-4 relative z-30">
//         <div className="search-header-item flex items-center mb-4">
//           <Link href="/">
//             <button className="flex items-center gap-2 text-teal-600 cursor-pointer hover:text-teal-700 transition-colors">
//               <ArrowLeft className="w-4 h-4" />
...
//       {/* ✅ CORRECTION MAJEURE: z-40 pour FilterPanel - au-dessus des cartes (z-10) mais sous le header (z-30) */}
//       <div className="max-w-7xl mx-auto px-4 py-6 relative z-40">
//         <div className="search-filters">
//           <FilterPanel
//             filters={filters}
//             onFilterChange={handleFilterChange}
...
//       {/* ✅ Résultats avec z-10 (sous les filtres) */}
//       <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
//         <div className="w-full">
//           <div className="search-results-header">
//             {/* ✅ CORRECTION: z-50 pour le dropdown de tri */}
//             <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
//               <div>
//                 <h2 className="text-lg font-semibold text-slate-800">
//                   {totalAvocats === 0
...
//       {/* ✅ Header z-50 */}
//       <div className="max-w-7xl mx-auto px-4 py-4 relative z-50">
//         <div className="search-header-item flex items-center mb-4">
//           <Link href="/">
//             <button className="flex items-center gap-2 text-teal-600 cursor-pointer hover:text-teal-700 transition-colors">
//               <ArrowLeft className="w-4 h-4" />
...
//               {/* ✅ CORRECTION CRITIQUE: Le CustomSelect a déjà z-[999] interne */}
//               {totalAvocats > 1 && (
//                 <div className="w-full sm:w-48">
//                   <CustomSelect
//                     options={triOptions}
...
function SearchResults() {
  ...
  return (
    <div className="min-h-screen pt-16 bg-gradient-to-br from-teal-100 via-white to-teal-100">
      ...
      {/* ✅ CORRECTION : Enlever z-10 du parent des résultats */}
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="w-full">
          <div className="search-results-header">
            {/* ✅ CORRECTION : z-[100] pour que le dropdown s'affiche au-dessus */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 relative z-[100]">
              <div>
                <h2 className="text-lg font-semibold text-slate-800">
                  {totalAvocats === 0
                    ? "Aucun avocat trouvé"
              ...
              {/* ✅ Le CustomSelect hérite maintenant du z-[100] */}
              {totalAvocats > 1 && (
                <div className="w-full sm:w-48">
                  <CustomSelect
                    options={triOptions}
          ...
          {/* ✅ CORRECTION : relative sans z-index pour les cartes */}
