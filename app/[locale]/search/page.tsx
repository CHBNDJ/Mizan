...
function SearchResults() {
  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-br from-teal-100 via-white to-teal-100">
      <style>{`.search-header { opacity:0; } .search-avocat-card { opacity:0; }`}</style>

      <div className="search-header sticky top-20 z-50 border-b border-slate-200/60 bg-white/90 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3">
          <div className="flex items-center gap-1.5 sm:gap-2 mb-2 flex-wrap">
            <Link href={`/${professionParam}`}>
              <button className="flex items-center gap-1 text-teal-600 hover:text-teal-700 text-xs sm:text-sm font-medium cursor-pointer me-1 sm:me-2">
