          ...
          <div className="prose prose-slate max-w-none space-y-8">
            <div className="animate-section bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-amber-800 text-sm">{t("warningP")}</p>
                </div>
              </div>
            </div>
            ...
            <section className="animate-section">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
                ...
                <p className="text-slate-700">
                  <strong className="text-slate-900">{t("s1.operator")}</strong>{" "}
                  Chabane Nadji
                </p>
                <p className="text-slate-700">
                  <strong className="text-slate-900">{t("s1.status")}</strong>{" "}
                  {t("s1.statusValue")}
                </p>
                <p className="text-slate-700">
                  <strong className="text-slate-900">
                ...
                <p className="text-slate-700">
                  <strong className="text-slate-900">{t("s1.phone")}</strong>{" "}
                  +33 6 60 25 35 70
                </p>
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded">
                  <p className="text-blue-800 text-xs">📋 {t("s1.regNote")}</p>
                </div>
              </div>
            </section>
            ...
            <section className="animate-section">
              ...
              <div className="bg-teal-50 border border-teal-200 rounded-lg p-6">
                ...
                <p className="text-teal-800 leading-relaxed">{t("s1b.p2")}</p>
            ...
            <section className="animate-section">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
                <p className="text-slate-700">
                  <strong className="text-slate-900">{t("s3.host")}</strong>{" "}
                  {t("s3.hostValue")}
                </p>
              </div>
            </section>
            ...
            <section className="animate-section">
              ...
              <p className="text-slate-700 leading-relaxed">{t("s4.p1")}</p>
            ...
            <section className="animate-section">
              ...
              <p className="text-slate-700 leading-relaxed">{t("s6.p1")}</p>
            </section>
            ...
            <section className="animate-section">
              ...
              <p className="text-slate-700 leading-relaxed">{t("s8.p1")}</p>
            </section>
