      ...
      <div className="max-w-4xl mx-auto px-4 py-12" ref={containerRef}>
        ...
        <div className="bg-white dark:bg-[#1c1c1e] rounded-2xl border border-slate-200 dark:border-[#1c2220] p-8 md:p-12">
          <div className="animate-section flex items-center gap-3 mb-6">
            <Shield className="w-8 h-8 text-teal-600 dark:text-[#6fcf9f]" />
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            ...
            <section className="animate-section">
              ...
              <div className="bg-blue-50 dark:bg-[#1F2E3D] border border-blue-200 dark:border-[#2A4A5A] rounded-lg p-6">
                ...
                <ul className="list-disc list-inside space-y-2 text-blue-800 dark:text-[#7FB3E0]">
                  {t.raw("s2.sources").map((item: string, i: number) => (
                    <li key={i}>{item}</li>
                  ))}
                </ul>
                <h3 className="font-semibold text-blue-900 dark:text-[#7FB3E0] mt-5 mb-3">
                  🔍 {t("s2.natureTitle")}
                </h3>
                <ul className="list-disc list-inside space-y-2 text-blue-800 dark:text-[#7FB3E0]">
                ...
                <p className="text-blue-800 dark:text-[#7FB3E0] leading-relaxed">
                  {t("s2.useP")}
                </p>
                <h3 className="font-semibold text-blue-900 dark:text-[#7FB3E0] mt-5 mb-3">
                  📧 {t("s2.infoTitle")}
                ...
                <div className="mt-4 p-4 bg-blue-100 dark:bg-[#2A4A5A] border border-blue-300 dark:border-[#3A5A6A] rounded">
                  <p className="text-blue-900 dark:text-[#7FB3E0] font-semibold mb-2">
                    🛡️ {t("s2.rightsTitle")}
                  </p>
                  <p className="text-blue-800 dark:text-[#7FB3E0] text-sm mb-2">
                    {t("s2.rightsP")}
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-blue-800 dark:text-[#7FB3E0] text-sm">
                    <li>{t("s2.rightRectif")}</li>
                    <li>{t("s2.rightDelete")}</li>
                    <li>{t("s2.rightOppose")}</li>
                    <li>{t("s2.rightAccess")}</li>
                  </ul>
                  <p className="text-blue-800 dark:text-[#7FB3E0] text-sm mt-3">
                ...
                <p className="text-blue-800 dark:text-[#7FB3E0] leading-relaxed mt-4 text-sm">
                  {t("s2.note")}
                </p>
              </div>
            </section>
            ...
            <section className="animate-section">
              ...
              <p className="text-slate-700 dark:text-[#E8E8E6] leading-relaxed mb-3">
                {t("s4.p1")}
              </p>
              <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-[#E8E8E6]">
              ...
              <p className="text-slate-700 dark:text-[#E8E8E6] leading-relaxed mt-4 font-semibold">
                {t("s4.neverSell")}
              </p>
            </section>
