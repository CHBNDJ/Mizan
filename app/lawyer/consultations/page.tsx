...
//       const formattedData: Consultation[] =
...
//     try {
//       console.log("🔍 Chargement messages pour:", consultationId);

//       // 1. Charger les messages sans jointure
...
//         console.log("ℹ️ Aucun message");
//         setMessages([]);
//         return;
//       }

//       // 2. Récupérer les infos des senders (unique IDs seulement)
//       const senderIds = [...new Set(messagesData.map((m) => m.sender_id))];
//       console.log("🔍 Senders à charger:", senderIds);
...
//       console.log("✅ Senders récupérés:", sendersData?.length);
...
//       console.log("✅ Messages enrichis:", enrichedMessages.length);
