  ...
  return (
    <div className="min-h-screen pt-16 bg-white" ref={containerRef}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* ── Hero teal-600 ── */}
        <div className="hero-section bg-teal-600 rounded-2xl p-7 sm:p-8 mb-6 text-white">
          ...
          <p className="text-teal-100 text-base font-medium mb-3 leading-snug">
            {data.tagline}
          </p>
        ...
        {/* ── 2 colonnes : Missions + Quand faire appel ── */}
        <div className="section-card grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
          {/* Missions */}
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-sm font-bold text-slate-900 mb-4">Missions</h2>
