        ...
        <div className="section-card bg-white border border-slate-200 rounded-2xl p-6 mb-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {data.missions.map((m, i) => (
              <div
                key={i}
                className="flex gap-3 p-4 bg-teal-50/60 border border-teal-100 rounded-xl"
              >
        ...
        <div className="section-card bg-white border border-slate-200 rounded-2xl p-6 mb-4 shadow-sm">
          ...
          <div className="space-y-2.5">
            {data.quandFaireAppel.map((q, i) => (
              <div
                key={i}
                className="flex gap-3 p-4 border border-slate-100 rounded-xl hover:border-teal-100 hover:bg-teal-50/30 transition-all"
              >
