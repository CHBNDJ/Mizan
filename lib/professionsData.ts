...
> = {
  ...
  traducteur: {
    ...
    labelPlural: "Traducteurs Assermentés",
    tagline:
      "Vos traductions officielles à valeur légale, reconnues par les administrations",
    intro:
      "Le traducteur assermenté est agréé par le Ministère de la Justice pour produire des traductions officielles à valeur légale. Il traduit vos actes d'état civil, jugements, diplômes, contrats et documents administratifs, avec un cachet reconnu par les administrations algériennes et étrangères. Il est indispensable pour toute démarche de visa, d'immigration, d'équivalence de diplômes ou de dossier judiciaire international, que vous soyez en Algérie ou dans la diaspora.",
    cadreJuridique:
      "Le traducteur assermenté — officiellement traducteur-interprète officiel — exerce sous l'agrément du Ministère de la Justice. Il prête serment devant la cour, et son cachet confère à ses traductions une valeur officielle opposable aux administrations et aux juridictions. Ses traductions sont reconnues aussi bien pour les actes destinés aux autorités algériennes que pour ceux présentés aux autorités étrangères, ce qui en fait un maillon essentiel des démarches transfrontalières.",
    missions: [
      {
        emoji: "📄",
        title: "Traduction d'actes d'état civil",
        desc: "Actes de naissance, de mariage et de décès traduits et certifiés pour vos démarches administratives en Algérie ou à l'étranger. C'est la traduction la plus demandée pour les dossiers de visa et d'immigration.",
      },
      {
        emoji: "🎓",
        title: "Traduction de diplômes",
        desc: "Diplômes et relevés de notes traduits officiellement pour l'équivalence, la poursuite d'études ou la recherche d'emploi à l'étranger. Une exigence standard des universités et employeurs étrangers.",
      },
      {
        emoji: "⚖️",
        title: "Documents judiciaires",
        desc: "Jugements, actes de procédure et pièces de dossier traduits avec valeur légale pour les procédures internationales et la coopération judiciaire.",
      },
      {
        emoji: "📝",
        title: "Contrats et actes notariés",
        desc: "Contrats commerciaux, procurations et actes notariés traduits fidèlement et certifiés, pour vos affaires avec des partenaires étrangers.",
      },
      {
        emoji: "🗣️",
        title: "Interprétariat officiel",
        desc: "Interprétation lors d'audiences, d'auditions, de mariages ou de signatures d'actes nécessitant la présence d'un interprète assermenté.",
      },
      {
        emoji: "🌍",
        title: "Documents pour la diaspora",
        desc: "Traduction de tout document algérien destiné à une administration étrangère (ou l'inverse) : dossiers consulaires, actes, attestations, certificats.",
      },
    ],
    quandFaireAppel: [
      {
        situation: "Vous préparez un dossier de visa ou d'immigration",
        detail:
          "Les consulats et services d'immigration exigent des traductions assermentées de vos actes d'état civil et pièces justificatives. Une traduction libre est systématiquement refusée.",
      },
      {
        situation: "Vous demandez une équivalence de diplôme",
        detail:
          "Toute équivalence à l'étranger passe par une traduction officielle de vos diplômes et relevés de notes par un traducteur agréé.",
      },
      {
        situation: "Vous avez un dossier judiciaire international",
        detail:
          "Les jugements et pièces destinés à une juridiction étrangère, ou reçus de l'étranger, doivent être traduits par un assermenté pour être recevables.",
      },
    ],
    differences: [
      {
        avec: "un traducteur classique",
        distinction:
          "Seul le traducteur assermenté peut produire une traduction à valeur officielle, reconnue par les administrations et les tribunaux. Un traducteur non assermenté ne peut pas certifier ses traductions.",
      },
      {
        avec: "le notaire",
        distinction:
          "Le notaire authentifie et rédige des actes ; le traducteur assermenté en produit la version officielle dans une autre langue. Les deux interviennent souvent ensemble sur les dossiers internationaux.",
      },
    ],
    searchProfession: "traducteur",
  },
};
